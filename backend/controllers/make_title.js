...
export const make_title=(req, res)=>{
    ...
    const set_title=req.body

    console.log(set_title)

    for( const el of set_title.rda["course"]){
        course_rdas+=`${el}<br>`
    }
    course_rdas=course_rdas.slice(0,-4)

    for( const el of set_title.rda.program){
        program_rdas+=`${el}<br>`
    }
    program_rdas=program_rdas.slice(0,-4)

    console.log(program_rdas)

    const title=`<div class="accordion" id="recpre-1" data-toggle="collapse" data-target="#bar-a" aria-expanded="true" aria-controls="bar-a">
    
        <div class="etiqueta-moodle" style="display:flex;flex-direction:row;border-radius:10px;overflow:hidden;height:70px;">
            <div class="c1" style="display:flex;align-items:center;width:60%;background-color:#35133b;border-radius:10px 0 0 10px;font-size:20px; height: 50px; color:#ffffffff;">
                <svg style="height: 70px;margin-right:20px; margin-top:20px" class="pill" viewBox="0 0 70 74.42">
                    <path fill="#da2d43" d="M4.56,43.87L1.93,39.2c-4.34-7.71-1.1-17.21,7.24-21.22L42.81,1.78c8.34-4.01,18.62-1.02,22.96,6.69l2.63,4.67c4.34,7.71,1.1,17.21-7.24,21.22L27.51,50.56C19.17,54.57,8.9,51.58,4.56,43.87z"></path>
                </svg>
                ${set_title.lema}
    
            </div>
    
            <div class="c2" style="width:40%;background-color:#2277AA;border-radius:0 10px 10px 0;text-align:center;display:flex;justify-content:center;align-items:center;font-size:20px; height: 50px; color:#ffffffff">${set_title.name}<br></div>
    ...
    <div id="bar-a" class="collapse show" aria-labelledby="headingOne" data-parent="#recpre-1" style="">
    
        <div class="titmod-container" data-toggle="modal" data-target="#item-rda">
            <div class="box">
    
                <div class="title">
                    <span class="block" style="background:#424999;"></span>
    
                    <icono class="fa-stack mx-2">
                        <i style="color:white" class="fa fa-square fa-stack-2x"></i>
                        <i style="color:#424999;" class="fa fa-map-pin fa-stack-1x"></i>
                    </icono>
                    <h1 class="p-3" style="color:white;">
                        <div>
                            Resultados de Aprendizaje</div>
                        <div><br>
    ...
    <div class="modal fade" id="item-rda" tabindex="-1" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog" role="document" style=" max-width: 90%; margin: 1.75rem auto;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Resultados de Aprendizaje</h5>
                    ...
                    <div class="container mt-3">
                        <div class="row">
                            <div class="col-3" >
                                ...
                                <svg version="1.1" height="150px" width="150px" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                            ...
                            <div class="col-9">
                                <p class="h3"><strong>
                                        Resultados de Aprendizaje de la Asignatura <br><br>
    
                                    </strong></p>
    
                                <p class="h5 text-justify" style="line-height: 1.5;">
                        ...
                        <div class="row">
                            <div class="col-9">
                                <p class="h3"><strong>
                                        Resultados de Aprendizaje de la Carrera <br><br>
                ...
                <div class="modal-footer">
                    <div class="d-flex justify-content-around">
                        ...
                        <div style="background-color: #df1527dd; border-radius: 10px; padding: 7px;" data-toggle="modal" data-target="#item-rda">
                            <span class="fa fa-sign-out fa-inverse" style="font-size: 30px;"></span>
                        </div>
